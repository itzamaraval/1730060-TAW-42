<?php
    ...
    class estudiante_model{
        ...
        function get(){
            $sql= "SELECT e.id,e.cedula AS cedula,CONCAT(e.nombre,' ',e.apellidos) AS alumno,e.edad AS edad,e.promedio AS promedio,u.nombre AS universidad, c.nombre AS carrera, e.universidad_id, e.fecha_reg FROM estudiante AS e
